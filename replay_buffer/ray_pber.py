...
class CustomPrioritizedReplayBuffer(PrioritizedReplayBuffer):
    def __init__(
        ...
        super(CustomPrioritizedReplayBuffer, self).__init__(**kwargs)
        self.beta = beta
...
@DeveloperAPI
class MultiAgentBatchedPrioritizedReplayBuffer(MultiAgentReplayBuffer, CustomPrioritizedReplayBuffer):
    ...
    def __init__(
        ...
        prioritized_replay_buffer_config = {
            "type": CustomPrioritizedReplayBuffer,
